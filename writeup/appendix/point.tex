...
\begin{table}
    ...
    \caption{Listing of the variables used in the regression models at the Point beaches. For each variable, the listing indicates which summary statistics were computed, and over what time scales.}
    \label{table:point-variables}
