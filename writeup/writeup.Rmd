...
save.image("C:/Users/wrbrooks/bc_env.Rdata")
```
...
```{r counts-barcharts, fig.width=12, fig.height=16, fig.cap='At each site, the number of predictions from AL, GBM-OOB, and GBM-CV that fell into four categories, from left: true negatives, false positives, true positive, and false negatives.', echo=FALSE, warning=FALSE, message=FALSE, dev='pdf', dpi=1000}
    # Set up the page
    grid.newpage()
